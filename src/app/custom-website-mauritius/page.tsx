...
const page = businessSeoPages["custom-website-mauritius"];
const canonicalUrl = "https://mobiz.mu/custom-website-mauritius";
...
export default function CustomWebsiteMauritiusPage() {
