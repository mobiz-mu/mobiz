...
const page = businessSeoPages["school-website-mauritius"];
const canonicalUrl = "https://mobiz.mu/school-website-mauritius";
...
export default function SchoolWebsiteMauritiusPage() {
