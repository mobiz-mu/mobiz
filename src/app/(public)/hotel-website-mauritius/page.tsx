...
const page = businessSeoPages["hotel-website-mauritius"];
const canonicalUrl = "https://mobiz.mu/hotel-website-mauritius";
...
export default function HotelWebsiteMauritiusPage() {
