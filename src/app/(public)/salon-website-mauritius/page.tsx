...
const page = businessSeoPages["salon-website-mauritius"];
const canonicalUrl = "https://mobiz.mu/salon-website-mauritius";
...
export default function SalonWebsiteMauritiusPage() {
