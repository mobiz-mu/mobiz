...
const page = businessSeoPages["booking-system-mauritius"];
const canonicalUrl = "https://mobiz.mu/booking-system-mauritius";
...
export default function BookingSystemMauritiusPage() {
