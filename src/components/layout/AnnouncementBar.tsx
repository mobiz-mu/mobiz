...
const whatsappHref = `https://wa.me/23055068119?text=${encodeURIComponent(
  whatsappMessage
)}`;
  ...
  return (
    ...
    >
      ...
      <Container className="relative z-[1]">
        <div className="flex min-h-[56px] items-center justify-between gap-2 py-2 sm:min-h-[62px] sm:justify-start sm:gap-3">
          ...
          <div
            className="relative hidden min-w-0 flex-1 overflow-hidden sm:block"
            ...
            <div className="flex w-max items-center animate-[mobiz-marquee_46s_linear_infinite] will-change-transform">
              {marqueeItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <span className="flex items-center gap-2 whitespace-nowrap px-4 text-[12px] font-medium tracking-[0.05em] text-white/90 lg:text-[13px]">
                      <span className="relative inline-flex h-5 w-5 items-center justify-center rounded-full border border-[#d6b866]/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.18),rgba(255,255,255,0.04))] shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_4px_10px_rgba(0,0,0,0.28),0_0_10px_rgba(212,181,90,0.10)]">
                        <span className="absolute inset-[1px] rounded-full bg-[radial-gradient(circle_at_30%_25%,rgba(255,255,255,0.30),transparent_45%)]" />
                        <Icon className="relative h-3 w-3 text-[#f1d47b] drop-shadow-[0_1px_2px_rgba(0,0,0,0.55)]" />
                      </span>
                    ...
                    <span
                      aria-hidden="true"
                      className="px-1 text-[11px] font-bold text-[#e7c96b]/80"
                    >
                      |
                    </span>
                  </div>
      ...
      <style>{`
        ...
        .mobiz-social-icon {
          animation: mobiz-social-fade 3.6s ease-in-out infinite;
          animation-delay: var(--mobiz-delay);
        }
