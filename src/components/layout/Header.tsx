...
const promoItems = [
  ...
  { text: "CV from Rs 999", icon: FileText },
];
  ...
  >
    <div className="flex h-[76px] items-center gap-2 sm:h-[82px] sm:gap-3 lg:hidden">
      ...
      <div className="relative flex h-[42px] min-w-0 flex-1 items-center overflow-hidden rounded-full border border-[#d7aa2e] bg-[linear-gradient(180deg,#ffd86a_0%,#f6be3b_52%,#df9f14_100%)] px-2.5 shadow-[0_16px_30px_rgba(201,138,14,0.20),inset_0_2px_0_rgba(255,255,255,0.30),inset_0_-8px_14px_rgba(111,67,2,0.14)] sm:h-[46px] sm:px-3">
        ...
        >
          <span className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-black/10 bg-white/28 text-[#071226] shadow-[0_8px_16px_rgba(7,18,38,0.10)] sm:h-8 sm:w-8">
    ...
    <div className="hidden lg:grid lg:h-[92px] lg:grid-cols-[92px_270px_minmax(0,1fr)_124px] lg:items-center lg:gap-3 xl:grid-cols-[96px_290px_minmax(0,1fr)_128px] xl:gap-4 2xl:grid-cols-[102px_310px_minmax(0,1fr)_132px]">
      ...
      <div className="relative flex h-[48px] min-w-0 items-center overflow-hidden rounded-full border border-[#d7aa2e] bg-[linear-gradient(180deg,#ffd86a_0%,#f6be3b_52%,#df9f14_100%)] px-3 shadow-[0_15px_28px_rgba(201,138,14,0.18),inset_0_2px_0_rgba(255,255,255,0.28),inset_0_-8px_14px_rgba(111,67,2,0.12)] xl:h-[50px] xl:px-3.5">
        ...
        >
          <span className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-black/10 bg-white/28 text-[#071226] shadow-[0_8px_16px_rgba(7,18,38,0.10)]">
      ...
      <div className="min-w-0">
        <nav className="relative flex w-full min-w-0 overflow-hidden rounded-full border border-[#c8d1df]/45 bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_100%)] px-1.5 py-1.5 shadow-[0_18px_40px_rgba(2,8,20,0.16),0_0_0_1px_rgba(255,255,255,0.75)_inset]">
          ...
          <div className="relative z-10 flex w-full min-w-0 flex-nowrap items-center gap-0.5">
            <button
              ...
              className={cn(
                "inline-flex shrink-0 items-center gap-2 whitespace-nowrap rounded-full px-3 py-2.5 text-[12.5px] xl:text-[13px] 2xl:text-[13.5px] font-semibold tracking-[0.01em] transition duration-300",
            ...
            {mainNavLinks.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "shrink-0 whitespace-nowrap rounded-full px-2 py-2.5 text-[12.5px] xl:px-2.5 xl:text-[13px] 2xl:px-3 2xl:text-[13.5px] font-semibold tracking-[0.01em] transition duration-300",
                    active
