export type LeadMagnetKey = "free_seo_audit" | "free_website_review" | "free_business_consultation";
import { CONTACT_PHONE_RAW } from "@/lib/site";
...
export const leadMagnets: Record<LeadMagnetSlug, LeadMagnetData> = {
  "free-seo-audit": {
    ...
    metaTitle: "Free SEO Audit Mauritius",
    metaDescription:
  ...
  "free-website-review": {
    ...
    metaTitle: "Free Website Review Mauritius",
    metaDescription:
  ...
  "free-business-consultation": {
    ...
    metaTitle: "Free Business Consultation Mauritius",
    metaDescription:
