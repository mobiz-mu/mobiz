...
export const businessSeoPages: Record<BusinessSeoPageKey, BusinessSeoPageData> = {
  ...
  "hotel-website-mauritius": {
    ...
    metaTitle:
      "Hotel Website Mauritius | Rooms, Offers & Booking Website Design",
    metaDescription:
  ...
  "villa-booking-website-mauritius": {
    ...
    metaTitle:
      "Villa Booking Website Mauritius | Holiday Rental Website Design",
    metaDescription:
  ...
  "real-estate-website-mauritius": {
    ...
    metaTitle:
      "Real Estate Website Mauritius | Property Listing Website Design",
    metaDescription:
  ...
  "doctor-clinic-website-mauritius": {
    ...
    metaTitle:
      "Doctor Clinic Website Mauritius | Healthcare Website Design",
    metaDescription:
  ...
  "school-website-mauritius": {
    ...
    metaTitle:
      "School Website Mauritius | Academy & Education Website Design",
    metaDescription:
  ...
  "construction-website-mauritius": {
    ...
    metaTitle:
      "Construction Website Mauritius | Contractor Website Design",
    metaDescription:
  ...
  "accounting-firm-website-mauritius": {
    ...
    metaTitle:
      "Accounting Firm Website Mauritius | Accountant Website Design",
    metaDescription:
  ...
  "law-firm-website-mauritius": {
    ...
    metaTitle:
      "Law Firm Website Mauritius | Legal Website Design",
    metaDescription:
  ...
  "custom-website-mauritius": {
    ...
    subtitle:
      "MoBiz.mu builds bespoke websites for Mauritius businesses whose requirements go past a standard website package \u2014 custom layouts, member areas, advanced forms and integrations.",
    metaTitle:
    ...
    overviewParagraphs: [
      "Some businesses cannot be represented properly by a standard website package. The service flow is unusual, the customer journey has extra steps, or the site has to do something a template simply will not do.",
      "MoBiz.mu builds bespoke websites in Mauritius for exactly those cases \u2014 custom layouts, a content structure planned around your services, and features designed around how your customers actually move through the site.",
      "That can mean advanced enquiry forms, a members or client area, listing and gallery sections, or connecting the site to a tool you already use. It is still a website. If what you actually need is software to run your day-to-day operations, our web application development page covers that instead.",
    ],
    ...
    features: [
      ...
      { title: "Advanced enquiry forms", description: "Multi-step forms, quote builders and conditional fields a standard contact form cannot handle." },
      { title: "Member and client areas", description: "Login-protected pages where customers or members reach content meant only for them." },
      { title: "Third-party integrations", description: "Connect the site to the calendars, payment links, mailing tools or systems you already use." },
    ...
    benefits: [
      "Present a business a template cannot describe properly",
      "Guide visitors through a journey built around your service",
      "Handle enquiries that need more than a name and a message",
      "Give members or clients their own protected area",
      "Connect the website to tools you already work in",
      "Add features later without rebuilding the site",
    ],
    ...
    faqs: [
      ...
      { question: "Can the website include special features?", answer: "Yes. Advanced forms, member areas, listing sections and integrations can be planned. For internal systems such as dashboards or CRM, see our web application development page." },
    ...
    relatedLinks: [
      ...
      { title: "Web Application Development (business software)", href: "/web-application-development-mauritius" },
      ...relatedLinksFor("custom-website-mauritius"),
    ],
  },
  ...
  "web-application-development-mauritius": {
    ...
    subtitle:
      "MoBiz.mu develops custom web applications for Mauritius businesses \u2014 dashboards, customer and staff portals, booking management, CRM and inventory tools that replace manual admin.",
    metaTitle:
    ...
    overviewTitle: "Software that runs part of your business",
    overviewParagraphs: [
      "When the day-to-day is held together by spreadsheets, WhatsApp messages and paper records, the problem is no longer the website. The business has no system.",
      "MoBiz.mu builds custom web applications in Mauritius that replace that manual admin \u2014 one place where your team records what happened, sees current data, and follows the same process every time.",
      "That might be an admin dashboard, a customer or staff portal, booking management, a CRM, or an inventory tool, with role-based access so people only see what they should. If you mainly need a public-facing website, our custom website page is the better fit.",
    ],
    ...
    benefits: [
      "Replace spreadsheets and paper records",
      "Stop re-entering the same data in several places",
      "Give the whole team one version of the truth",
      "Control who can see and change what",
      "Make the process the same every time",
      "Build the system around how you already work",
    ],
    ...
    relatedLinks: [
      { title: "CRM Software Mauritius", href: "/crm-software-mauritius" },
      { title: "Inventory Movement & Warehouse Tracking", href: "/inventory-management-system-mauritius" },
      { title: "Booking & Reservation Management", href: "/booking-system-mauritius" },
      { title: "Accounting Software Mauritius", href: "/accounting-software-mauritius" },
      ...relatedLinksFor("web-application-development-mauritius"),
    ],
  },
  ...
  "inventory-management-system-mauritius": {
    ...
    subtitle:
      "MoBiz.mu builds inventory management systems for Mauritius businesses that need to track goods moving in and out \u2014 receiving, dispatch, suppliers, locations and movement history.",
    metaTitle:
    ...
    secondaryKeywords: [
      "warehouse management system Mauritius",
      "inventory software Mauritius",
      "goods receiving system Mauritius",
      "product tracking system Mauritius",
      "supplier and purchase tracking Mauritius",
    ],
    ...
    overviewTitle: "Track how goods move through your business",
    overviewParagraphs: [
      "Inventory gets hard to trust the moment goods arrive, get moved, get sent out and get returned without anyone recording it in the same place.",
      "MoBiz.mu builds inventory management systems in Mauritius that follow the movement \u2014 what was received from which supplier, where it was put, what left, and what the history looks like afterwards.",
      "It suits wholesale, import and export, retail chains and warehouse operations. If what you mainly need is a live count of what is on the shelf and when to reorder, our stock control system page covers that.",
    ],
    featuresTitle: "What we can include in an inventory system",
    features: [
      { title: "Product and SKU records", description: "Store product names, SKUs, categories, units and supplier details." },
      { title: "Goods received", description: "Record what arrived, from which supplier, against which purchase." },
      { title: "Dispatch and transfers", description: "Record what left, where it went, and what moved between locations." },
      { title: "Supplier and purchase history", description: "Keep the buying record attached to the products it relates to." },
      { title: "Multiple locations", description: "Follow the same product across more than one store or warehouse." },
      { title: "Movement history", description: "See the full trail of a product rather than only its current number." },
    ],
    benefitsTitle: "Benefits of inventory management software",
    benefits: [
      "Know what arrived and what actually left",
      "Trace a product back through its movement history",
      "Keep supplier and purchase records in one place",
      "Follow goods across more than one location",
      "Settle disputes with a record instead of memory",
      "Replace notebooks and scattered spreadsheets",
    ],
    ...
    relatedLinks: [
      { title: "Stock Control & Reorder Levels", href: "/stock-management-system-mauritius" },
      { title: "Web Application Development Mauritius", href: "/web-application-development-mauritius" },
  ...
  "stock-management-system-mauritius": {
    ...
    subtitle:
      "MoBiz.mu builds stock control systems for Mauritius businesses that need to know exactly what is on hand \u2014 live quantities, stock counts, reorder points and low-stock alerts.",
    metaTitle:
    ...
    secondaryKeywords: [
      "stock control software Mauritius",
      "stock level tracking Mauritius",
      "low stock alert system Mauritius",
      "reorder point software Mauritius",
      "stock count system Mauritius",
    ],
    ...
    overviewTitle: "Know exactly what you have, and when to reorder",
    overviewParagraphs: [
      "Most stock problems come down to two questions nobody can answer quickly: how many do we actually have, and when should we order more.",
      "MoBiz.mu builds stock control systems for Mauritius businesses that answer both \u2014 a live quantity per product, counts that reconcile against it, and a reorder point that flags items before they run out.",
      "It suits shops, restaurants, salons, workshops and any business holding products it cannot afford to run out of. If you need to trace goods across suppliers, dispatches and multiple warehouses, our inventory management page covers that instead.",
    ],
    featuresTitle: "What we can include in your stock system",
    features: [
      { title: "Live quantity per product", description: "One current number per product, visible without opening a spreadsheet." },
      { title: "Stock counts", description: "Run a count and reconcile it against what the system expected." },
      { title: "Adjustments with a reason", description: "Record breakages, samples and corrections so the number stays honest." },
      { title: "Reorder points", description: "Set a level per product that flags it before you run out." },
      { title: "Low-stock alerts", description: "See what needs ordering now rather than discovering it at the counter." },
      { title: "Overstock visibility", description: "Spot money sitting in products that are not moving." },
    ],
    benefitsTitle: "Benefits of a stock management system",
    benefits: [
      "Answer how many we have without checking the shelf",
      "Reorder before something runs out, not after",
      "Reconcile counts instead of guessing at the difference",
      "See which products are tying up money",
      "Cut the mistakes that come from manual tallies",
      "Give staff one number everyone trusts",
    ],
  ...
  "crm-software-mauritius": {
    ...
    metaTitle:
      "CRM Software Mauritius | Lead & Customer Management System",
    metaDescription:
  ...
  "invoice-software-mauritius": {
    ...
    metaTitle:
      "Invoice Software Mauritius | Invoicing & Quotation System",
    metaDescription:
