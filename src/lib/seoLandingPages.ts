...
export const seoLandingPages: Record<SeoLandingPageKey, SeoLandingPageData> = {
  "website-design-mauritius": {
    ...
    metaTitle:
      "Website Design Mauritius | Professional Websites from Rs 8,000 | MoBiz.mu",
    metaDescription:
  ...
  "ecommerce-website-mauritius": {
    ...
    metaTitle:
      "Ecommerce Website Mauritius | Online Store Development | MoBiz.mu",
    metaDescription:
  ...
  "digital-marketing-mauritius": {
    ...
    metaTitle:
      "Digital Marketing Mauritius | SEO, Social Media & Google Ads | MoBiz.mu",
    metaDescription:
  ...
  "accounting-services-mauritius": {
    ...
    metaTitle:
      "Accounting Services Mauritius | Bookkeeping, VAT & Tax Filing | MoBiz.mu",
    metaDescription:
  ...
  "company-registration-mauritius": {
    ...
    metaTitle:
      "Company Registration Mauritius | Business Setup Services | MoBiz.mu",
    metaDescription:
  ...
  "vat-filing-mauritius": {
    ...
    metaTitle:
      "VAT Filing Mauritius | VAT Computation & Return Support | MoBiz.mu",
    metaDescription:
  ...
  "seo-services-mauritius": {
    ...
    metaTitle:
      "SEO Services Mauritius | Google Ranking & Local SEO | MoBiz.mu",
    metaDescription:
